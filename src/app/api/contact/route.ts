      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background: #FAF8F5; border-radius: 8px;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr><td style="padding: 8px 0; color: #6B6560;"><strong>Email</strong></td><td style="padding: 8px 0;"><a href="mailto:${email}" style="color: #D97706;">${email}</a></td></tr>
            <tr><td style="padding: 8px 0; color: #6B6560;"><strong>Company</strong></td><td style="padding: 8px 0; color: #1C1A18;">${company || "—"}</td></tr>
            <tr><td style="padding: 8px 0; color: #6B6560;"><strong>Subject</strong></td><td style="padding: 8px 0; color: #1C1A18;">${subject}</td></tr>
          </table>
