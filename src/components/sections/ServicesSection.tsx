...
const services = [
  ...
  },
  {
    ...
    benefits: ["Audit of your data, team capacity, and AI readiness gaps", "Each use case scored by ROI potential and delivery risk", "A prioritised roadmap your leadership can fund and own"],
  ...
  },
  {
    ...
    benefits: ["Automates complete workflows, not just isolated steps", "ERP, CRM, and email integrations", "Human escalation for exceptions"],
  ...
  },
  {
    ...
    desc: "A compact AI model trained on your data and terminology — it knows your domain the way GPT-4 never will, at 60–80% lower cost to run.",
    benefits: ["Trained on your documents, jargon, and domain processes", "On-prem or air-gapped deployment", "Gets smarter over time from your team's corrections"],
  ...
  },
  {
    ...
    benefits: ["Vision inspection, sensor analytics, document pipelines — scoped to your workflow", "Integrates with your existing stack", "Knowledge transfer so your team owns it"],
    outcome: "AI built for your workflow — not repurposed from someone else's.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-10 sm:mb-14">
          ...
          <h2 className="font-serif font-bold leading-tight max-w-xl" style={{ fontSize: "clamp(1.8rem,4.5vw,3.5rem)", color: "#0C1A2E" }}>
            Six AI systems.<br />Every one built for production.
          </h2>
        </motion.div>
                  ...
                  <div className="flex-1 p-7 sm:p-9 flex flex-col justify-center gap-5 bg-white">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t" style={{ borderColor: "rgba(15,23,42,0.06)" }}>
                      ...
                      <a href="/contact" className="flex items-center gap-1.5 text-sm font-semibold group/link shrink-0 ml-4" style={{ color: svc.accent }}>
                        Start a project <ArrowRight size={13} className="group-hover/link:translate-x-0.5 transition-transform" />
                      </a>
                    </div>
                  </div>
                </div>
