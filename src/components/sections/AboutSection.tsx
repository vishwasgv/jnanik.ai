...
const founders = [
  {
    ...
    bio: "18 years at Bosch in IoT and telematics, then 3 years at AWS on cloud and GenAI strategy. Both taught me the same thing: the gap between a demo and a production system is an engineering discipline problem, not a model problem. I founded Jnanik AI to close that gap.",
    brings: [
      { label: "Enterprise domain fluency", detail: "Two decades across Bosch and AWS — I understand how enterprise procurement, buy-in, and technical decisions actually work." },
      { label: "Industrial operations depth", detail: "Factory SOPs, IoT pipelines, automotive-grade telematics. I understand the environment our AI must operate inside." },
      { label: "Phase 0 data readiness", detail: "Our pre-build audit framework catches the failure pattern before we write a single line of agent code. Weeks added upfront — quarters saved downstream." },
      { label: "Commercial architecture", detail: "From first conversation to signed engagement to production system — I own the full path." },
    ],
  ...
  },
  {
    ...
    bio: "15 years building production systems at Bosch — 8 as Senior Software Engineer in Bengaluru, 7 as Software Architect in Stuttgart. M.S. AI from Georgia Tech. I joined Jnanik because industrial AI is one of the few domains where the engineering rigour I've spent my career developing genuinely matters.",
    brings: [
      { label: "Full-stack AI architecture", detail: "From data ingestion to retrieval pipelines, agent orchestration, model serving, and the API surface that connects it to your existing systems." },
      { label: "Production-grade defaults", detail: "15 years at Bosch means reliability and zero tolerance for systems that pass QA but fail in field conditions." },
      { label: "Georgia Tech AI depth", detail: "Formal ML training on top of architectural experience — decisions that hold up theoretically and in production." },
      { label: "Scalability and sovereignty", detail: "Multi-tenant deployments, on-prem constraints, data residency, compliance audit trails — enterprise-ready from day one." },
    ],
