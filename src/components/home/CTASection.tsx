      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div
            ...
            style={{ background: "radial-gradient(circle, rgba(37,99,235,0.2) 0%, transparent 65%)", transform: "translate(20%,-30%)" }}
          />
          <div
            className="absolute bottom-0 left-0 w-72 h-72 rounded-full blur-3xl pointer-events-none"
            style={{ background: "radial-gradient(circle, rgba(79,70,229,0.12) 0%, transparent 65%)", transform: "translate(-20%,20%)" }}
          />
          ...
          <motion.div
            ...
            viewport={vp}
          >
            <motion.div variants={fadeOnly} className="section-label-light mb-7 sm:mb-8 inline-flex">
            ...
            <motion.h2
              ...
              style={{ fontSize: "clamp(1.75rem,4.5vw,3.25rem)", color: "#F1F5F9" }}
            >
              Talk to our engineers.<br />
              <span className="shimmer-text-on-dark">Not our sales team.</span>
            </motion.h2>

            <motion.p variants={fadeUp} className="text-base sm:text-lg leading-relaxed mb-8 sm:mb-10" style={{ color: "#94A3B8" }}>
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-4">
              <motion.a
                whileHover={{ scale: 1.04, boxShadow: "0 12px 40px rgba(37,99,235,0.5)" }}
                whileTap={{ scale: 0.97 }}
                ...
                style={{ background: "linear-gradient(135deg, #2563EB, #4F46E5)", color: "#fff", boxShadow: "0 4px 20px rgba(37,99,235,0.4)" }}
              >
              ...
              <motion.a
                ...
                style={{ background: "rgba(255,255,255,0.06)", border: "1.5px solid rgba(255,255,255,0.12)", color: "#E2E8F0" }}
              >
                Send a Message
