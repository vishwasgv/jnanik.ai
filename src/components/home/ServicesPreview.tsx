          ...
          {services.map((svc, i) => (
            ...
            >
              ...
              <div
                ...
                style={{ background: "linear-gradient(to top, rgba(7,15,29,0.97) 0%, rgba(7,15,29,0.6) 50%, rgba(7,15,29,0.15) 100%)" }}
              />
              <div
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6">
                ...
                <h3 className="font-extrabold text-base sm:text-lg mb-2 leading-snug" style={{ color: "#EEF2FF" }}>{svc.title}</h3>
                <p className="text-xs leading-relaxed mb-3 max-h-0 overflow-hidden group-hover:max-h-20 transition-all duration-500" style={{ color: "#94A3B8" }}>
                  {svc.desc}
                </p>
